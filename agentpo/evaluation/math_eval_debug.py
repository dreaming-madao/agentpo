...
def parse_args():
    ...
    parser.add_argument("--model_name_or_path", default="/home/sunl/verl_rl/ckpts/unsloth_Llama-3.2-3B-Instruct", type=str)
    ...
    parser.add_argument("--n_sampling", default=2, type=int)
