...
PROMPT_TEMPLATES = {
    ...
    "llama3": (
        ...
        "{input} Let\'s think step by step and output the final answer within \\boxed{{}}.<|eot_id|><|start_header_id|>assistant<|end_header_id|>\n\n",
        "{output}", 
        "\n\n"
    ),
    "qwen25-math-cot-ft": (
