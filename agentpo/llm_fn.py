...
configs = {
    "Qwen-max-uaes-1206": ["qwen-max", dashscope_api_key],
    "Qwen-plus-uaes-1206": ["qwen-plus", dashscope_api_key],
    "deepseek-r1-uaes-1206": ["deepseek-r1", dashscope_api_key],
    "deepseek-v3-uaes-1206": ["deepseek-v3", dashscope_api_key],
    "Qwen2.5-Math-7B-DashScope": ["qwen2.5-math-7b-instruct", dashscope_api_key],
    ...
    "qwq-32b-preview-uaes-1206": ["qwq-32b-preview", dashscope_api_key]
}
