...
class TaskRunner:
    def run(self, config):
        ...
        os.environ["TENSORBOARD_DIR"] = config.trainer.default_local_dir
        ...
        elif reward_manager_name == "agentpo":
            from .reward_manager_agentpo import AgentPORewardManager
            reward_manager_cls = AgentPORewardManager
        else:
            raise NotImplementedError
