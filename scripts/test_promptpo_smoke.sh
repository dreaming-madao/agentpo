...
MODEL_PATH="/mnt/huawei/leiy/checkpoints/agentpo/AgentPO/smoke_Qwen2.5-3B_Llama-3.2-3B/merged_hf_model_last"
OUTPUT_DIR="/mnt/huawei/leiy/checkpoints/agentpo/AgentPO/smoke_Qwen2.5-3B_Llama-3.2-3B/eval_promptpo_smoke"
...
python -u agentpo/evaluation/math_eval_promptpo.py \
    ...
    --num_test_sample 2 \
    --tokenizer_mode slow \
    --actor_model Llama-3.2-3B \
    --cooperation_mode assistant \
    --seed 0 \
    --temperature 0.7 \
    --top_p 1.0 \
    --top_k -1 \
