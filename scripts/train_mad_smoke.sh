...
python3 -m agentpo.main_dapo \
    ...
    algorithm.cooperation_mode=${cooperation_mode} \
    +algorithm.mad.backend=${mad_backend} \
    +algorithm.mad.vllm_model_path="${mad_vllm_model_path}" \
    ...
    actor_rollout_ref.actor.use_focal_weight=${use_focal_weight} \
    ...
    actor_rollout_ref.rollout.max_num_seqs=${actor_ppo_max_token_len} \
