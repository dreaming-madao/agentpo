    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        with self.update_sampling_params(**kwargs):
            ...
            if self.sampling_params.n > 1 and do_sample:
                ...
                if "gold_completion" in non_tensor_batch.keys():
                    non_tensor_batch["gold_completion"] = _repeat_interleave(non_tensor_batch["gold_completion"], self.sampling_params.n)
